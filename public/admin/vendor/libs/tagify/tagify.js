                ...
                var g,
                    ...
                    p = {
                            ...
                            binding(t = !0) {
                                var e = this.dropdown.events.callbacks,
                                    i = (this.listeners.dropdown = this
                                        .listeners.dropdown || {
                                        position:
                                            this.dropdown.position.bind(this),
                                    ...
                                    switch (t.key) {
                                        ...
                                        case "Tab":
                                            if (
                                                ...
                                                t.preventDefault();
                                                var a =
                                                    this.dropdown.getMappedValue.call(
                                                        this,
                                                        i
                                                    );
                                                return (
                        ...
                        getSuggestionDataByNode(t) {
                            var e = t
                                ? +t.getAttribute("tagifySuggestionIdx")
                                : -1;
                        ...
                        filterListItems(t, e) {
                            ...
                            for (
                                ...
                                i =
                                    c[m] instanceof Object
                                        ? c[m]
                                        : { value: c[m] };
                                let t = Object.keys(i).some((t) =>
                                    u.includes(t)
                                )
                                    ? u
                                    : ["value"];
                            ...
                            return d([], t)
                                .map((t, e) => {
                                    ("string" != typeof t &&
                                        "number" != typeof t) ||
                                        (t = { value: t });
                                    var i = this.dropdown.getMappedValue.call(
                                        this,
                                        t
                                    );
                                    t.value =
                                    ...
                                    var s =
                                        this.settings.templates.dropdownItem.call(
                                            this,
                                            t
                                        );
                                    return s
                    ...
                    v = {
                        ...
                        callbacks: {
                            ...
                            onMixTagsInput(t) {
                                ...
                                if (
                                    window.getSelection &&
                                    (o = window.getSelection()).rangeCount >
                                        0 &&
                                ...
                                setTimeout(() => {
                                    this.update({ withoutChangeEvent: !0 }),
                                        ...
                                        this.state.tag &&
                                            this.dropdown[
                                                n ? "show" : "hide"
                                            ].call(this, this.state.tag.value);
                                }, 10);
                            },
                            onInputIE(t) {
                                var e = this;
                            ...
                            onEditTagInput(t, e) {
                                var i = t.closest(
                                    ...
                                    o =
                                        i.innerHTML !=
                                        i.__tagifyTagData.__originalHTML,
                                    r = this.validateTag({
                            ...
                            onEditTagBlur(t) {
                                if (
                                    ...
                                    var e,
                                        ...
                                        o =
                                            s.innerHTML !=
                                            s.__tagifyTagData.__originalHTML,
                                        r = this.validateTag({
                                            [i.tagTextProp]: a,
                                        });
                                    if (a)
                ...
                return (
                    (f.prototype = {
                        ...
                        applySettings(t, e) {
                            ...
                            if (
                                ...
                                ["whitelist", "blacklist"].forEach((e) => {
                                    ...
                                    s &&
                                        (s = s.split(i.delimiters)) instanceof
                                            Array &&
                                        (i[e] = s);
                                }),
                                "autoComplete" in e &&
                                    !l(e.autoComplete) &&
                                    ((i.autoComplete = u.autoComplete),
                                    (i.autoComplete.enabled = e.autoComplete)),
                                "mix" == i.mode &&
                                    ((i.autoComplete.rightKey = !0),
                                    (i.delimiters = e.delimiters || null),
                                    i.tagTextProp &&
                                        !i.dropdown.searchKeys.includes(
                                            i.tagTextProp
                                        ) &&
                                        i.dropdown.searchKeys.push(
                                            i.tagTextProp
                                        )),
                                t.pattern)
                            )
                                ...
                                if ("mix" == i.mode)
                                    ...
                                    this.addTags(t).forEach(
                                        (t) =>
                                            t &&
                                            t.classList.add(
                                                i.classNames.tagNoAnimation
                                            )
                                    );
                                }
                            else this.postUpdate();
                            (this.state.lastOriginalValueReported = i.mixMode
                                .integrated
                                ? ""
                                : this.DOM.originalInput.value),
                        ...
                        insertAfterTag(t, e) {
                            if (
                                ((e =
                                    e || this.settings.mixMode.insertAfterTag),
                                t && t.parentNode && e)
                            )
                                return (
                                    (e =
                        ...
                        editTag(t, e) {
                            ...
                            if (a) {
                                if (
                                    !(o instanceof Object && "editable" in o) ||
                                    o.editable
                                )
                                    return (
                        ...
                        replaceTag(t, e) {
                            (e && e.value) || (e = t.__tagifyTagData),
                                e.__isValid &&
                                    ...
                                    d(
                                        e,
                                        this.getInvalidTagAttrs(e, e.__isValid)
                                    );
                        ...
                        getTagElms(...t) {
                            ...
                            return [].slice.call(
                                this.DOM.scope.querySelectorAll(e)
                            );
                        },
                        getLastTag() {
                        ...
                        selectTag(t, e) {
                            if (
                                ...
                                return (
                                    ...
                                    this.state.actions.selectOption &&
                                        setTimeout(
                                            this.setRangeAtStartEnd.bind(this)
                                        ),
                                    this.getLastTag()
                                ...
                                ? ((t = this.normalizeTags(t)),
                                  "mix" == a.mode
                                      ...
                                      : ("select" == a.mode && (e = !1),
                                        ...
                                        this.dropdown.refilter.call(this),
                                        s))
                                : ("select" == a.mode && this.removeAllTags(),
                                  s);
                        },
                        addMixTags(t) {
